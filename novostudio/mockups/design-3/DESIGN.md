# Novo Studio – Design Concept 3 (DESIGN.md - webarchitect dark-luxury)

**Preset:** `dark-luxury` (Stitch Web Architect Framework)  
**Karaktär:** Djup natt, exklusiv brons/champagne-accent, krispiga 1px-linjer, fysiskt djup på knappar, noll AI-slop.
